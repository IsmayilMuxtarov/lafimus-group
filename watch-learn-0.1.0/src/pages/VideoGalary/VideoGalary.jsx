    ...
    let videoByThree = videos.map((video, key) => (
        <IonCol key={key}
            ...
            <IonImg
                ...
                src={ (video.video_type === 1) ? `https://turbologo.com/articles/wp-content/uploads/2019/10/youtube-logo-illustration-678x381.jpg` : `http://img.youtube.com/vi/${video.youtube_id}/0.jpg`}
            >
            </IonImg>
            {/*views and */}
            <p className={style.views}>Viewed<span> {video.look_count}</span></p>
